...
const hashPwd_1 = require("../../backend/utils/hashPwd");
const skillsData = [
...
const seedDatabase = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield dbConn_1.sequelize.sync({ force: true });
        console.log("Database models synced successfully.");
        // Seed Skills
        yield models_1.Skill.bulkCreate(skillsData);
        console.log("Skills seeded.");
        // Seed Lines
        yield models_1.ProductionLine.bulkCreate(linesData);
        console.log("Production lines seeded.");
        // Seed Workstations
        yield models_1.Workstation.bulkCreate(workstationsData);
        console.log("Workstations seeded.");
        // Seed Shifts
        yield models_1.Shift.bulkCreate(shiftsData);
        console.log("Shifts seeded.");
        // Seed Associates
        yield models_1.Associate.bulkCreate(associatesData);
